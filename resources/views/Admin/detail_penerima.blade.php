...
<section class="content-header">
      <ol class="breadcrumb">
        ...
        <li><a href="{{ route('data_penerima') }}"></i>Data Penerima</a></li>
            ...
            <div class="box box-danger">
              <div class="box-header">
                    ...
                    <div class="box-tools pull-right">
                        <a href="{{ route('data_penerima') }}"><button class="btn btn-warning"><i class="fa fa-sign-out"> Kembali</i></button></a>
                    </div>
                </div>
                <div class="box-body table-responsive">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <label>Penghasilan:</label>
                                <h4>{{ $detail_penerima->penghasilan }}</h4>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group has-feedback">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <a href="{{ route('hapus_penerima',$detail_penerima->id) }}"><button type="submit" class="btn btn-sm btn-danger btn-block btn-flat" onclick="return confirm('apakah anda yakin ingin menghapus data ini ?')"><i class="fa fa-trash"></i> Hapus</button></a>
                        </div>
                    </div>
                </div>
            </div>
