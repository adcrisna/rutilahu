              ...
              <tbody>
                 @foreach($penerima as $key => $value)
                    <tr>
                      ...
                      <td>
                        <a href="{{ route('detail_penerima',$value->id) }}"><button class="btn btn-xs btn-primary">&nbsp;<i class="fa fa-eye"> &nbsp;</i>Detail</button></a> &nbsp;
                        <a href="{{ route('hapus_penerima',$value->id) }}"><button class="btn btn-xs btn-danger" onclick="return confirm('apakah anda yakin ingin menghapus data ini ?')">&nbsp;<i class="fa fa-trash"> &nbsp;</i>Hapus</button></a>
                      </td>
                    </tr>
                    @endforeach
              </tbody>
