...
@section('content')
    <section class="content-header">
      <ol class="breadcrumb">
        ...
        <li class="active">Data Calon Penerima</li>
      </ol>
      <br/>
    </section>
      ...
      <div class="col-xs-12">
          <div class="box box-danger">
              <div class="box-header">
                <h3 class="box-title">Data Calon Penerima Bantuan</h3>
                <div class="box-tools pull-right">
                  
                </div>
              </div>
              <div class="box-body table-responsive">
                 <table class="table table-bordered table-striped" id="data-calon">
            <thead>
              <tr>
              ...
              <tbody>
                 @foreach($calon as $key => $value)
                    <tr>
                      ...
                      <td>
                        <a href="{{ route('detail_calon',$value->id) }}"><button class="btn btn-xs btn-primary">&nbsp;<i class="fa fa-eye"> &nbsp;</i>Lihat Detail Calon</button></a> &nbsp;
                      </td>
                    </tr>
                    @endforeach
              </tbody>
