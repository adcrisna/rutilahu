         ...
         <div class="box">
          <div class="box-header">
                ...
                <div class="box-tools pull-right">
                        <a href="{{ route('home_pemukiman') }}"><button class="btn btn-xs btn-warning"><i class="fa fa-sign-out"> Kembali</i></button></a>
                </div>
          </div>
          <div class="box-body table-responsive">
            <form action="{{ route('update_pemukiman') }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
