      ...
      <div class="col-xs-12">
         <div class="box">
          ...
          <div class="form-group has-feedback">
            ...
            <input type="hidden" name="dokumen_id" readonly class="form-control" value="{{ $profile->dokumen_id }}" readonly>
          </div>
            <div class="form-group has-feedback">
            ...
            <div class="form-group has-feedback">
                ...
                <input type="text" name="penghasilan" class="form-control" value="{{ $profile->penghasilan }}" readonly>
            </div>
            <div class="row">
        <div class="col-md-4">
          <div class="form-group has-feedback">
        ...
        <div class="col-md-6">
          ...
          <div class="col-md-6">
            <div class="form-group has-feedback">
                ...
                <p><img width="250px" height="200px" src="{{ asset('uploads/'.$profile->ktp) }}"></p>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
            <div class="form-group has-feedback">
                ...
                <p><img width="250px" height="200px" src="{{ asset('uploads/'.$profile->sertifikat_tanah) }}"></p>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group has-feedback">
                <label>Foto Kartu Keluarga : </label>
                <p><img width="250px" height="200px" src="{{ asset('uploads/'.$profile->kartu_keluarga) }}"></p>
            </div>
          </div>
        </div>
          <div class="row">
