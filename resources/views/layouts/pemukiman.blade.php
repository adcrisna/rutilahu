...
<link rel="shortcut icon" href="{{ asset('logo-dprkp.png') }}" type="image/x-icon" />
  ...
  <header class="main-header">
    <a href="{{ route('home_admin') }}" class="logo">
      ...
      <span class="logo-lg"><b>Pemukiman</b></span>
    </a>
